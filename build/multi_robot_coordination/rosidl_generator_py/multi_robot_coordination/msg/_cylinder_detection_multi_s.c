...
bool multi_robot_coordination__msg__cylinder_detection_multi__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("multi_robot_coordination.msg._cylinder_detection_multi.CylinderDetectionMulti", full_classname_dest, 77) == 0);
  }
  multi_robot_coordination__msg__CylinderDetectionMulti * ros_message = _ros_message;
  {  // detected
  ...
  {  // target_namespace
    PyObject * field = PyObject_GetAttrString(_pymsg, "target_namespace");
    if (!field) {
      return false;
    }
    assert(PyUnicode_Check(field));
    ...
    rosidl_runtime_c__String__assign(&ros_message->target_namespace, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // header
...
{
  /* NOTE(esteve): Call constructor of CylinderDetectionMulti */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("multi_robot_coordination.msg._cylinder_detection_multi");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CylinderDetectionMulti");
  ...
  {  // target_namespace
    PyObject * field = NULL;
    field = PyUnicode_DecodeUTF8(
      ros_message->target_namespace.data,
      strlen(ros_message->target_namespace.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "target_namespace", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
