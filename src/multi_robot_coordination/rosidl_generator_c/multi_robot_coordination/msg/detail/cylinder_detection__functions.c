...
multi_robot_coordination__msg__CylinderDetection__init(multi_robot_coordination__msg__CylinderDetection * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->robot_namespace)) {
    multi_robot_coordination__msg__CylinderDetection__fini(msg);
    return false;
  }
  // x
  // y
...
multi_robot_coordination__msg__CylinderDetection__create()
{
  ...
  multi_robot_coordination__msg__CylinderDetection * msg = (multi_robot_coordination__msg__CylinderDetection *)allocator.allocate(sizeof(multi_robot_coordination__msg__CylinderDetection), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(multi_robot_coordination__msg__CylinderDetection));
  bool success = multi_robot_coordination__msg__CylinderDetection__init(msg);
  if (!success) {
...
multi_robot_coordination__msg__CylinderDetection__Sequence__init(multi_robot_coordination__msg__CylinderDetection__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  multi_robot_coordination__msg__CylinderDetection * data = NULL;

  if (size) {
    data = (multi_robot_coordination__msg__CylinderDetection *)allocator.zero_allocate(size, sizeof(multi_robot_coordination__msg__CylinderDetection), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = multi_robot_coordination__msg__CylinderDetection__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        multi_robot_coordination__msg__CylinderDetection__fini(&data[i - 1]);
      }
...
multi_robot_coordination__msg__CylinderDetection__Sequence__fini(multi_robot_coordination__msg__CylinderDetection__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      multi_robot_coordination__msg__CylinderDetection__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  multi_robot_coordination__msg__CylinderDetection__Sequence * array = (multi_robot_coordination__msg__CylinderDetection__Sequence *)allocator.allocate(sizeof(multi_robot_coordination__msg__CylinderDetection__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = multi_robot_coordination__msg__CylinderDetection__Sequence__init(array, size);
  if (!success) {
...
multi_robot_coordination__msg__CylinderDetection__Sequence__destroy(multi_robot_coordination__msg__CylinderDetection__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    multi_robot_coordination__msg__CylinderDetection__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
multi_robot_coordination__msg__CylinderDetection__Sequence__are_equal(const multi_robot_coordination__msg__CylinderDetection__Sequence * lhs, const multi_robot_coordination__msg__CylinderDetection__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!multi_robot_coordination__msg__CylinderDetection__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  multi_robot_coordination__msg__CylinderDetection__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(multi_robot_coordination__msg__CylinderDetection);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    multi_robot_coordination__msg__CylinderDetection * data =
      (multi_robot_coordination__msg__CylinderDetection *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!multi_robot_coordination__msg__CylinderDetection__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          multi_robot_coordination__msg__CylinderDetection__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!multi_robot_coordination__msg__CylinderDetection__copy(
