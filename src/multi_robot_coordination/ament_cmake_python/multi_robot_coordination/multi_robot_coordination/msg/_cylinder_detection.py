...
class Metaclass_CylinderDetection(type):
    """Metaclass of message 'CylinderDetection'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'multi_robot_coordination.msg.CylinderDetection')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__cylinder_detection
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__cylinder_detection
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__cylinder_detection
            cls._TYPE_SUPPORT = module.type_support_msg__msg__cylinder_detection
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__cylinder_detection
...
class CylinderDetection(metaclass=Metaclass_CylinderDetection):
    """Message class 'CylinderDetection'."""
