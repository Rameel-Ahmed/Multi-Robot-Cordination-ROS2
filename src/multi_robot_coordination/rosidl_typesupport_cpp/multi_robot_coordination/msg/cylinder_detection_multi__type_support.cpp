...
static const _CylinderDetectionMulti_type_support_symbol_names_t _CylinderDetectionMulti_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, multi_robot_coordination, msg, CylinderDetectionMulti)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, multi_robot_coordination, msg, CylinderDetectionMulti)),
  }
};
...
{
  return &::multi_robot_coordination::msg::rosidl_typesupport_cpp::CylinderDetectionMulti_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, multi_robot_coordination, msg, CylinderDetectionMulti)() {
  return get_message_type_support_handle<multi_robot_coordination::msg::CylinderDetectionMulti>();
}
